            ...
            <div className="relative">
                <input
                    ...
                    className={cn(
                        ...
                        error
                            ? "border-red-500 focus:ring-2 focus:ring-red-500/20 focus:border-red-500 shadow-glow-red"
                            : success
                                ? "border-green-500 focus:ring-2 focus:ring-green-500/20 focus:border-green-500 shadow-glow-green"
                                : "border-gray-200 dark:border-white/10 focus:border-primary-500 focus:ring-2 focus:ring-primary-500/20 focus:shadow-glow-blue",
