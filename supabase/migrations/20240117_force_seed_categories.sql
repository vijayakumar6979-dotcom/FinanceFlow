-- Force clean and seed categories
...
INSERT INTO transaction_categories (name, type, icon, color, is_system) VALUES
    ...
    ('School Fees', 'expense', 'graduation-cap', '#4338CA', true),
    ('Tuition Fees', 'expense', 'book-open', '#6366F1', true),
    ('Books & Stationery', 'expense', 'pencil', '#818CF8', true),
